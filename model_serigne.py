...
score = rmsle_cv(model_xgb, train, y_train, n_folds=n_folds)
print("Xgboost score: {:.4f} ({:.4f})\n".format(score.mean(), score.std()))
score = rmsle_cv(model_lgb, train, y_train, n_folds=n_folds)
...
score = rmsle_cv(averaged_models, train, y_train, n_folds=n_folds)
...
score = rmsle_cv(stacked_averaged_models, train, y_train, n_folds=n_folds)
